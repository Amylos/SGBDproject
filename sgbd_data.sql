...
('Manette de Jeu', 'Manette sans fil pour des sessions de jeu confortables.', 50, 'disponible', 1, 2, NOW(), NOW()),
('Chaussures de Foot', 'Chaussures de football professionnelles pour terrains synthétiques.', 100, 'disponible', 2, 3, NOW(), NOW()),
('Ballon de Basket', 'Ballon de basket en caoutchouc durable pour entraînements.', 30, 'disponible', 2, 4, NOW(), NOW()),
...
('Tapis de Course', 'Tapis de course pour un entraînement à domicile.', 300, 'disponible', 2, 8, NOW(), NOW()),
('Complément Protéiné', 'Protéines en poudre pour la prise de masse musculaire.', 40, 'disponible', 3, 9, NOW(), NOW()),
('Sac de Sport', 'Sac robuste pour transporter tout le nécessaire pour le sport.', 20, 'disponible', 2, 10, NOW(), NOW());
